...
namespace Inktweb\Bolcom\RetailerApi\Enums\Models\V10\Retailer\OrderFulfilment;
...
class TimeFrameType extends Enum
{
    ...
    protected array $allowedValues = ['REGULAR', 'EVENING', 'APPOINTMENT', 'SAMEDAY', 'SUNDAY'];
