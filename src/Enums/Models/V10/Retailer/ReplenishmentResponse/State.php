...
namespace Inktweb\Bolcom\RetailerApi\Enums\Models\V10\Retailer\ReplenishmentResponse;
...
class State extends Enum
{
    ...
    protected array $allowedValues = ['ANNOUNCED', 'IN_TRANSIT', 'ARRIVED_AT_WH', 'IN_PROGRESS_AT_WH', 'CANCELLED', 'DONE'];
