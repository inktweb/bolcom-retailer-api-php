...
namespace Inktweb\Bolcom\RetailerApi\Enums\Models\V10\Retailer\ChangeTransportRequest;
...
class TransporterCode extends Enum
{
    ...
    public static function trunkrs(): self
    {
        return (new static())->set(static::TRUNKRS);
    }

    public function isTrunkrs(): bool
    {
        return $this->is(static::TRUNKRS);
    }

    public static function cycloon(): self
    {
        return (new static())->set(static::CYCLOON);
    }

    public function isCycloon(): bool
    {
        return $this->is(static::CYCLOON);
    }
}
