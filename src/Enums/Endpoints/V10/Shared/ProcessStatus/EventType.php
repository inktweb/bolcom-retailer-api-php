...
namespace Inktweb\Bolcom\RetailerApi\Enums\Endpoints\V10\Shared\ProcessStatus;
...
class EventType extends Enum
{
    ...
    public const CREATE_SOV_SEARCH_TERM_REPORT = 'CREATE_SOV_SEARCH_TERM_REPORT';
    public const CREATE_SOV_CATEGORY_REPORT = 'CREATE_SOV_CATEGORY_REPORT';
    public const UPLOAD_INVOICE = 'UPLOAD_INVOICE';
    public const CREATE_CAMPAIGN_PERFORMANCE_REPORT = 'CREATE_CAMPAIGN_PERFORMANCE_REPORT';
    ...
    public static function createShipment(): self
    {
        return (new static())->set(static::CREATE_SHIPMENT);
    }

    public function isCreateShipment(): bool
    {
        return $this->is(static::CREATE_SHIPMENT);
    }
    ...
    public static function createSovSearchTermReport(): self
    {
        return (new static())->set(static::CREATE_SOV_SEARCH_TERM_REPORT);
    }

    public function isCreateSovSearchTermReport(): bool
    {
        return $this->is(static::CREATE_SOV_SEARCH_TERM_REPORT);
    }

    public static function createSovCategoryReport(): self
    {
        return (new static())->set(static::CREATE_SOV_CATEGORY_REPORT);
    }

    public function isCreateSovCategoryReport(): bool
    {
        return $this->is(static::CREATE_SOV_CATEGORY_REPORT);
    }

    public static function uploadInvoice(): self
    {
        return (new static())->set(static::UPLOAD_INVOICE);
    }

    public function isUploadInvoice(): bool
    {
        return $this->is(static::UPLOAD_INVOICE);
    }

    public static function createCampaignPerformanceReport(): self
    {
        return (new static())->set(static::CREATE_CAMPAIGN_PERFORMANCE_REPORT);
    }

    public function isCreateCampaignPerformanceReport(): bool
    {
        return $this->is(static::CREATE_CAMPAIGN_PERFORMANCE_REPORT);
    }
}
