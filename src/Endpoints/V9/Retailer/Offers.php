...
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\CreateOfferExportRequest;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\CreateOfferRequest;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\CreateUnpublishedOfferReportRequest;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\Problem;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\ProcessStatus;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\RetailerOffer;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\UpdateOfferPriceRequest;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\UpdateOfferRequest;
use Inktweb\Bolcom\RetailerApi\Models\V9\Retailer\UpdateOfferStockRequest;
...
final class Offers extends Endpoint
{
     ...
     * @throws UnknownCollectionFormatException
     */
    public function postUnpublishedOfferReport(CreateUnpublishedOfferReportRequest $body): ProcessStatus
    {
        return ProcessStatus::fromArray(
            $this->request(
                'post',
