...
use Inktweb\Bolcom\RetailerApi\Enums\Models\V7\Advertiser\BiddingModel\Strategy;

/**
 * @method static BiddingModel fromArray(array $data)
 */
final class BiddingModel extends Model
{
